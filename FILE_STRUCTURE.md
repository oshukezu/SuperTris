...
```
SuperTris/
├── index.html              # 主頁面入口（含 Title Screen、Canvas、整潔方框 HUD、D-Pad、Modal UI）
├── style.css               # 全域 8-bit Pixel 樣式與響應式排版
...
│   ├── tetris.js           # 遊戲主循環、消行觸發、雙特效並存、自動暫停 (331行)
