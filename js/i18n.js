// SuperTris 多語系字典 (i18n) - 全面移除 Emoji，採用純 8-Bit NES 風格
const I18N = {
  currentLang: 'zh-TW',
  translations: {
    'zh-TW': {
      ...
      coop_rank: '雙人榜',
      close: '關閉',
      item_red_mushroom: '[MUSHROOM] 分數 ×2 (+30秒)',
      item_green_mushroom: '[1UP] 獲得 1 條命！',
      item_fire_flower: '[FIRE FLOWER] 下 5 塊引爆炸彈！',
      item_super_star: '[SUPER STAR] 15秒穿透消除！',
      coin_100_bonus: '[100 COINS] 滿百獲得 1UP！',
      life_lost: '[LIFE LOST] 失去 1 條命！下半重整！',
    ...
    'en': {
      ...
      coop_rank: 'Co-op',
      close: 'Close',
      item_red_mushroom: '[MUSHROOM] Score ×2 (+30s)',
      item_green_mushroom: '[1UP] Life +1!',
      item_fire_flower: '[FIRE FLOWER] Next 5 drops bomb!',
      item_super_star: '[SUPER STAR] 15s Laser Clear!',
      coin_100_bonus: '[100 COINS] 1UP rewarded!',
